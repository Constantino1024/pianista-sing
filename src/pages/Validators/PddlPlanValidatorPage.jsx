        ...
        <div className="space-y-4">
          ...
          <div className="p-6 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-700 rounded-2xl">
            ...
            <div className="space-y-3 text-sm">
              <div>
                <strong className="text-purple-700 dark:text-purple-300">Initial State Setup:</strong>
              ...
              <div>
                <strong className="text-purple-700 dark:text-purple-300">Action-by-Action Validation:</strong>
                <p className="text-gray-700 dark:text-gray-300 mt-1">
              ...
              <div>
                <strong className="text-purple-700 dark:text-purple-300">Goal State Verification:</strong>
                <p className="text-gray-700 dark:text-gray-300 mt-1">
