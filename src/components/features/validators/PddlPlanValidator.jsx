  ...
  const handleSubmit = async (e) => {
    ...
    await handleAsyncOperation(
      () => {
        ...
        return postValidatePddlPlan(normalizedDomain, normalizedProblem, normalizedPlan);
      },
      {
        setLoading,
        setError,
  ...
  return (
    <Card className="space-y-4">
      <div className="flex justify-between items-center">
        <SectionHeader 
          title="Validate Problem Plan"
          description="Validate that a plan correctly solves the given domain and problem"
        />
        <button
          type="button"
          onClick={clearForm}
